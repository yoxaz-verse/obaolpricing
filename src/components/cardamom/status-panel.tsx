    ...
    <div className="rounded-2xl border border-[#1A261E] bg-[#0E1511] p-5 shadow-xl">
      ...
      <div className="space-y-3 text-sm text-slate-300">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="mt-6 flex w-full items-center justify-center gap-2.5 rounded-xl bg-[#25D366] px-4 py-3 text-sm font-bold text-white shadow-lg transition-transform hover:scale-[1.02] active:scale-95"
        >
