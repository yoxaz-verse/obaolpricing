// components/activity/activityTypeTabContent.tsx
"use client";
...
const ActivityTypeTabContent: React.FC = () => {
  const queryKey = ["activityType"];
  const apiEndpoint = activityTypeRoutes.getAll;
    ...
    <QueryComponent api={apiEndpoint} queryKey={queryKey} page={1} limit={100}>
      {(data: any) => {
        ...
        return (
          <>
            <AddModal
              currentTable="ActivityType"
              formFields={formFields}
              apiEndpoint={activityTypeRoutes.getAll}
            ...
            <CommonTable
              ...
              deleteModal={(item: any) => (
                ...
                <UserDeleteModal
                  _id={item._id}
                  name={item.name}
                  deleteApiEndpoint={activityTypeRoutes.getAll}
                  refetchData={refetchData}
                />
                // <div>ss</div>
              )}
...
export default ActivityTypeTabContent;
